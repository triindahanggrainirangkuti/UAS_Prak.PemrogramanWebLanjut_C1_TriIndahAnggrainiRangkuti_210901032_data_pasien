                  ...
                  @csrf
                    <div class="row">
                      ...
                      <div class="row">
                        <div class="col-sm-12">
                          ...
                          <input type="text" name="keluhan" class="form-control" placeholder="Input Keluhan" value="{{ Session::get('keluhan') }}">
                      </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <input type="date" name="tgl_periksa" id="" class="form-control" value="{{ Session::get('tgl_periksa') }}">
                        </div>
                    <div class="row">  
                        <div class="col-sm-12">
                            <label for="">Alamat</label>
                            <textarea name="alamat" id="" cols="20" rows="5" class="form-control" placeholder="Input alamat"></textarea value="{{ Session::get('alamat') }}">
                        </div>
                    </div>
